...
output_file = 'apr24/vgg16_untrained/VGG16_untrained_output.txt'
roc_curve_png = 'apr24/vgg16_untrained/ROC_curve_VGG16_untrained.png'
roc_curve_txt = 'apr24/vgg16_untrained/ROC_data_VGG16_untrained.csv'
confusion_matrix_png= 'apr24/vgg16_untrained/confusion_matrix_vgg16_untrained.png'
...
# Transform dataset input to match inputs for model
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/vgg16_untrained/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/vgg16_untrained", exist_ok=True)

    output_image_path = f"apr24/vgg16_untrained/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
