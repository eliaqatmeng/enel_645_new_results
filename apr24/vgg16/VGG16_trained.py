...
output_file = 'apr24/vgg16/VGG16_trained_output.txt'
roc_curve_png = 'apr24/vgg16/ROC_curve_VGG16_trained.png'
roc_curve_txt = 'apr24/vgg16/ROC_data_VGG16_trained.csv'
confusion_matrix_png= 'apr24/vgg16/confusion_matrix_vgg16_trained.png'
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/vgg16/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/vgg16", exist_ok=True)

    output_image_path = f"apr24/vgg16/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
